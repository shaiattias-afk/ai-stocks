"""
D-031 — warehouse loader for the last remaining "first fiscal year in
dataset" gap identified in D-030: CRWD FY2021 (report date 2021-01-31),
needed ONLY as the prior fiscal year for CRWD FY2022's
average_invested_capital/roic. Extends scripts/73/75/78/86/91/97
...
with --ticker CRWD --report-date 2021-01-31) and saved to the existing
...
Used ONLY to compute invested_capital for CRWD's FY2021 itself (via a
later script) — no fact from CRWD FY2022 is read when resolving this,
...
SCRIPT_NAME = "100_build_xbrl_warehouse_crwd_first_year_gap.py"
EXPECTED_FORM = "10-K"
...
def main() -> None:
    ...
    print("=" * 100)
    print("CRWD FIRST-YEAR-GAP WAREHOUSE LOAD — SUMMARY")
