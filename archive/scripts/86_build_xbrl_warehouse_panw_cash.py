...
SCRIPT_NAME = "86_build_xbrl_warehouse_panw_cash.py"
EXPECTED_FORM = "10-K"
...
# Widened after the proof (PANW 2023 vs 2024) confirmed one general,
# defensible role-title pattern — already_loaded() skips PANW 2023/2024,
# already in the warehouse from the proof stage.
