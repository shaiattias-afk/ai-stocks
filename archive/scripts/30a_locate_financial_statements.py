...
def find_filing_file(
    ...
    if manifest_file is not None:
        manifest_paths = (
            extract_existing_paths_from_manifest(
...
def locate_tables(
    ...
    previous_text_blocks: deque[str] = (
        deque(maxlen=8)
    )
