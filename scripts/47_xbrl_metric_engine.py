...
def output_paths(ticker: str, report_date: str) -> dict[str, Path]:
    ...
    return {
        "presentation_csv": (
            DATA_DIR / f"{prefix}_engine_v5_presentation.csv"
        ),
        "row_candidates_csv": (
            DATA_DIR / f"{prefix}_engine_v5_row_candidates.csv"
        ),
        "fact_candidates_csv": (
            DATA_DIR / f"{prefix}_engine_v5_fact_candidates.csv"
        ),
        "result_file": DATA_DIR / f"{prefix}_engine_v5_result.json",
        "arelle_log_file": (
            DATA_DIR / f"{prefix}_engine_v5_arelle_child.log"
        ),
        "orchestration_log_file": (
            DATA_DIR / f"{prefix}_engine_v5_orchestration.log"
        ),
    }
