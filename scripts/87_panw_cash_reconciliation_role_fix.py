...
TARGET_FILINGS: list[tuple[str, str, str]] = [
    ("PANW", "2021-07-31", "0001327567-21-000029"),
    ("PANW", "2022-07-31", "0001327567-22-000028"),
    ("PANW", "2023-07-31", "0001327567-23-000024"),
]
CONTROL_FILING: tuple[str, str, str] = ("PANW", "2024-07-31", "0001327567-24-000029")
...
def main() -> None:
    ...
    print(f"=== CONTROL TEST: {CONTROL_FILING[0]} {CONTROL_FILING[1]} ===")
    ...
    output_path = DATA_DIR / "d025_panw_cash_fix_results.json"
