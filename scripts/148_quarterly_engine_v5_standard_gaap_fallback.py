...
# =====================================================================
# THE ONE NEW MECHANISM — TIER 3 STANDARD US-GAAP CONCEPT ALLOW-LIST.
# =====================================================================

STANDARD_GAAP_ALLOW_LIST_VERSION = "STANDARD_GAAP_ALLOW_LIST_V1"

# Fixed, versioned. Extending this list requires evidence (a real,
# validated concept observed resolving a real case) and a new version
# string — never silently grown, never substring-matched.
...
# Documentation only — never queried, never matched against. The
# allow-list above is the entire universe this tier ever considers, so
# these categories are structurally excluded by construction, not by an
# explicit blocklist check:
#   us-gaap:CostOfRevenue, us-gaap:DeferredRevenue*,
#   us-gaap:ContractWithCustomerLiability*,
#   us-gaap:RevenueRemainingPerformanceObligation*,
#   any segment/member-dimensioned revenue fact (dimensions_json != '{}'),
#   us-gaap:IncomeTaxExpenseBenefit, us-gaap:OperatingIncomeLoss,
#   us-gaap:NetIncomeLoss, any concept outside the "us-gaap:" namespace
#   (ticker-specific extension concepts).
...
# Exactly the duration classes the downstream pipeline independently
# tries for each quarter — Q1 only ever accepts a direct-quarter value;
# Q2/Q3 accept a direct-quarter value or fall back to their own YTD.
...
# =====================================================================
# 1. DURATION CLASSIFICATION — unchanged from 136
# =====================================================================
...
# =====================================================================
# 2. FILING METADATA LOOKUP — unchanged from 136
# =====================================================================
...
# =====================================================================
# 3. FACT SELECTION — unchanged from 136
# =====================================================================
...
# =====================================================================
# 3b. ANNUAL ANCHOR RESOLUTION (D-037) — unchanged from 136, verbatim
# =====================================================================
...
# =====================================================================
# 3c. POINT-IN-TIME-SAFE CONCEPT-REUSE FALLBACK (TIER 2) — unchanged
#     from scripts/136, verbatim.
# =====================================================================
...
# =====================================================================
# 4. XBRL-DECIMALS ROUNDING-TOLERANCE POLICY (D-035) — unchanged from 136
# =====================================================================
...
# =====================================================================
# 5. THE ENGINE — same shape as 136; only the Q1/Q2/Q3 concept-resolution
#    block (marked below) gains the new tier-3 fallback attempt.
# =====================================================================
